...
# ═════════════════════════════════════════════════════════════════════════════
# A.  Q3 FIX  — real regular-vs-playoff player stats (1995-2023)
# ═════════════════════════════════════════════════════════════════════════════

print("── A. Fixing Q3: regular-vs-playoff player stats ───────")
...
║  data/processed/                                                     ║
║  ── Q3 fix ──                                                        ║
║  ├── q3_player_split_v2.csv      REAL reg-vs-playoff (1995-2023)     ║
